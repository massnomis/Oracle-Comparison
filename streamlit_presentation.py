...
kraken_eth_usd_prices_df = pd.read_csv('kraken_df_ETH_USD_2025-01-22_17-07-50.csv')
...
st.subheader("From Scroll Network")
st.markdown("this is an explaination of what this is and how to use it")
